...
// --- 2. MOOD CONFIG ---
const moodConfig = {
    Bollywood:   { label: "🌾 Golden Harvest — Bollywood", class: "mood-Bollywood",   color: "#f59e0b", glow: "rgba(245,158,11,0.35)" },
    Punjabi: { label: "🎬 Rose Cinema — Punjabi",    class: "mood-Punjabi", color: "#f43f5e", glow: "rgba(244,63,94,0.35)"  },
    English:   { label: "🎧 Ocean Neon — English",     class: "mood-English",   color: "#22d3ee", glow: "rgba(34,211,238,0.35)" }
};
